...
airy_jvm_deps = [
    ...
    "io.confluent:kafka-avro-serializer:6.2.12",
    "io.confluent:kafka-schema-registry-client:6.2.12",
    "io.confluent:kafka-schema-registry:6.2.12",
    "io.confluent:kafka-streams-avro-serde:6.2.12",
